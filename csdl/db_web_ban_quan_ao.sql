...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 22, 2021 lúc 07:15 AM
...
(90, 'Áo phông - Adidas', 'P-01', 'ao-phong-adidas.jpg', 1000000, 950000, 1, 26, 15, '1', ''),
...
(93, 'Áo len - Chanel', 'C-01', 'ao-len-chanel.jpg', 1500000, 1500000, 1, 29, 19, '1', ''),
(94, 'Áo khoác - Hermes', 'H-01', 'ao-khoac-hermes.jpg', 2000000, 1850000, 1, 28, 18, '1', '');
...
--
ALTER TABLE `sanpham`
  MODIFY `idsanpham` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
